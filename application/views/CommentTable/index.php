...
<div class="parent">
        ...
        <table class="user-table core-table">
            ...
            foreach ($comments as $comment): ?>
                <tr>
                    ...
                    <td>                        
                            <?php echo ($comment['comment'] == null) ? '<div class="audio-bar">
                    ...
                    <td>
                        <p>
                            <?= $comment['total_report'] ?>
                        </p>
                    </td>
                    <td>
                        <div class="action">
                            <div class="view-user" onclick="window.location.assign('<?= base_url() ?>Fullscreen/index/<?= $comment['user_id'] . '/' . $comment['content_id'] ?>')" style="cursor: pointer"><img
    ...
    <div class="bottom-setting">
        ...
        <div class="pagination-page">
            <p><span>
                    <?php echo ($start + 1) . '-' . ($start + count($comments)); ?>
                </span> of
                <?php echo $total_rows; ?>
            </p>
            <div class="chevron-parent">
                <?php if ($this->pagination->create_links()): ?>
                    ...
                    <?php if ($previous_page >= 0): ?>
                        <a href="<?php echo site_url("adminTable/Comment/".$comments[0]['content_id']."/{$previous_page}"); ?>">
                    ...
                    <?php if ($next_page < $total_rows): ?>
                        <a href="<?php echo site_url("adminTable/Comment/".$comments[0]['content_id']."/{$next_page}"); ?>">
